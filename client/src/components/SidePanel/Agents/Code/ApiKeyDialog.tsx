        ...
        main={
          <>
            <div className="mb-4 text-center font-medium">
              {localize('com_ui_openbiocure_code_api_title')}
            </div>
            <div className="mb-4 text-center text-sm">
              {localize('com_ui_openbiocure_code_api_subtitle')}
            </div>
            ...
            <div className="mb-6">
              ...
              <a
                href="https://code.openbiocure.ai/pricing"
                target="_blank"
              ...
              >
                {localize('com_ui_openbiocure_code_api_key')}
              </a>
            </div>
