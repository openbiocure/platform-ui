...
import { AgentCapabilities, defaultAgentFormValues } from 'openbiocure-data-provider';
import type { UseMutationResult, QueryObserverResult } from '@tanstack/react-query';
import type { Agent, AgentCreateParams } from 'openbiocure-data-provider';
  ...
  const resetAgentForm = useCallback(
    (fullAgent: Agent) => {
      ...
      const formValues: Partial<AgentForm & TAgentCapabilities> = {
        ...
        model: update.model,
        tools: agentTools,
        isExternal: fullAgent.isExternal ?? false,
      };
