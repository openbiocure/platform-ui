...
const TagPrimitiveRoot = React.forwardRef<HTMLDivElement, TagProps>(
  (
    ...
    <div
      ...
      {...props}
      className={cn(
        'flex max-h-8 items-center overflow-y-hidden rounded-3xl border-2 border-opencure-blue-600 bg-opencure-blue-600/20 text-xs text-opencure-blue-600 dark:text-white',
        className,
      )}
    >
      ...
      {CancelButton
        ...
        : onRemove && (
          <button
            ...
            className="rounded-full bg-opencure-blue-600/50"
