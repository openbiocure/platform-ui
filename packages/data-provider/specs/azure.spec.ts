...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should throw an error if environment variables are set but not configured', () => {
    const validConfigs: TAzureGroups = [
      {
        group: 'openbiocure-westus',
        apiKey: '${WESTUS_API_KEY}',
        instanceName: 'openbiocure-westus',
      ...
      {
        group: 'openbiocure-eastus',
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'openbiocure-eastus',
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'openbiocure-westus'
    expect(groupMap).toHaveProperty('openbiocure-westus');
    expect(groupMap['openbiocure-westus']).toEqual(
    ...
    // Check groupMap for 'openbiocure-eastus'
    expect(groupMap).toHaveProperty('openbiocure-eastus');
    expect(groupMap['openbiocure-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'openbiocure-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'openbiocure-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'openbiocure-eastus',
