import { extractopenbiocureParams } from './llm';

describe('extractopenbiocureParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractopenbiocureParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractopenbiocureParams();
  ...
  it('should extract all openbiocure params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractopenbiocureParams(options);
  ...
  it('should handle null values for openbiocure params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known openbiocure params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractopenbiocureParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional openbiocure params', () => {
    const options = {
      resendFiles: false,
