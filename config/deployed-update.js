...
(async () => {
  ...
  console.purple('Removing all tags for openbiocure `deployed` images...');
  const repositories = ['ghcr.io/danny-avila/openbiocure-dev-api', 'openbiocure-client'];
  ...
  console.purple('Pulling latest openbiocure images...');
