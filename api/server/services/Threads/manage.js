 ...
 * @param {import('openbiocure-data-provider').TFile[]} [params.files] - Optional. List of Attached File Objects.
...
/**
 * Records openbiocure messageId to all response messages' metadata
 *
 * @param {Object} params - The parameters for initializing a thread.
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.messageId - The response `messageId` generated by openbiocure.
...
/**
 * Synchronizes openbiocure messages to Thread Messages.
 * Updates the openbiocure DB with any missing Thread Messages and
 ...
 * @param {TMessage[]} params.dbMessages - The openbiocure DB messages.
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.endpoint - The current endpoint.
 * @param {string} [params.latestMessageId] - Optional: The latest message ID from openbiocure.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.run_id - Response Run ID.
 * @param {string} params.conversationId - openbiocure conversation ID.
 * @return {Promise<TMessage[]>} A promise that resolves to the updated messages
 */
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {RunClient} params.client - The openbiocure client that manages the run: either refers to `OpenAI` or `StreamRunManager`.
